...
1. [294](https://github.com/influxdata/influx-cli/pull/294): Fix permissions generated by usage of `--read-orgs`, `--write-orgs`, `--read-users`, and `--write-users` in `auth create`.
