...
func unmarshalRawDBI(rawDBI backup_restore.DatabaseInfo) influxdbV1DatabaseInfo {
...
func unmarshalRawRPI(rawRPI backup_restore.RetentionPolicyInfo) influxdbV1RetentionPolicyInfo {
...
func unmarshalRawSGI(rawSGI backup_restore.ShardGroupInfo) influxdbV1ShardGroupInfo {
...
func unmarshalRawShard(rawShard backup_restore.ShardInfo) influxdbV1ShardInfo {
